...
<body>
	<div id="templatemo_background_section_top">
    	<% PersonBean bean = (PersonBean)session.getAttribute("person"); 
			...
			String pageFwded="";
			if(bean.getType().equalsIgnoreCase("ADMIN")){
				pageFwded="addentity.jsp";
			}else{
				pageFwded="addeventsprofessor.jsp";
			}
		%>
    	<div class="templatemo_container">
        	...
        	<div id="templatemo_header">
				<div id="templatemo_logo_section">            
		        	<h1><a href="<%=pageFwded%>">Electronic Student Notice Board</a></h1>            
            ...
            <div id="templatemo_menu_panel"> 
				<div id="templatemo_menu_section">
					...
					<ul>
					  ...
					  <li><a href="categorysummary.jsp">Category Summary</a></li>
					   <li><a href="departmentsummary.jsp">Department Summary</a></li>		
					</ul> 
					<%}else{%>
						<ul>
        	...
        	<div id="templatemo_left_section">
                ...
                <div class="templatemo_post">
                    ...
                    <div class="templatemo_post_mid" style="height:400px">
							...
							<p>Records processed successfully!!Click <a href="<%=pageFwded%>">here</a> to go back to Add Entity page</p>
