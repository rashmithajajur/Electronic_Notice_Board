            ...
            <div id="templatemo_menu_panel"> 
				<div id="templatemo_menu_section">
					...
					<ul>
					  ...
					  <li><a href="viewpastevents.html">View All Events   </a></li>
					  <li><a href="updatesyudentinfo.html">Update Info   </a></li>
					  <li><a href="booktickets.html">Book Tickets</a></li>
					  <li><a href="subscribecategory.html">Subscribe Category</a></li>
        	...
        	<div id="templatemo_left_section">
                ...
                <div class="templatemo_post">
                    ...
                    <div class="templatemo_post_mid">
							...
							<p>Welcome Student Name. You have 0 alert(s)!!</p>
